...
const Sidebar = () => {
    ...
    return (
        <div className="w-full">
            ...
            <div className="lg:hidden flex justify-center items-center flex-col h-screen w-full text-lg text-center text-white capitalize font-bold bg-gradient-to-t from-indigo-500 to-red-500">Please Try this in Desktop for Better Experiance... <span className="text-3xl">😥</span></div>
        </div>
    );
};
